---
name: Plan File Locations
description: Where to find and save implementation plan documents for the Furigana project.
type: reference
---

Plan documents are stored at:
`.taskmaster/docs/plans/{date-flag} {suffix}/milestones/{milestone-number}-task-{task-number}-{Task-Name}.md`

The current active milestone directory is:
`.taskmaster/docs/plans/2026-03-17 MVP/milestones/`
